...
const portfolio = [
  { name: 'Tech Pioneer IT', id: 'tech-pioneer', cat: 'Corporate Website', color: '#0ea5e9', image: 'https://techpioneerit.netlify.app/img/hero-img.png', externalLink: 'https://techpioneerit.netlify.app/' },
  { name: 'DigiCredit - Lending App', id: 'digicredit', cat: 'Fintech UI/UX', color: '#7F77DD', image: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400/2f4e4e145628331.62a19ea8d4f51.png' },
  { name: 'HealthyBites - Food App', id: 'healthybites-ios', cat: 'Mobile app', color: '#1D9E75', image: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400/a03b23121701695.60d1991150610.png' },
];
      ...
      <section className={`${styles.hero} dotted-bg`}>
        <div className="container text-center">
          <div className={`${styles.heroBadge} reveal`}>
            ...
            Based in Bengaluru · Working worldwide
          </div>
          ...
          <div className={`btn-row centered reveal`}>
          ...
          <div className={`${styles.trustStrip} reveal`}>
            ...
            <span className={styles.trustPill}><IconShieldCheck size={16} color="var(--brand-accent)" /> 100% satisfaction</span>
          </div>
        </div>
      </section>
